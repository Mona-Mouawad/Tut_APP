...
class _$_RegisterObject implements _RegisterObject {
  _$_RegisterObject(this.userName, this.password, this.email, this.mobileNumber,
      this.countryMobileCode, this.profilePicture);
  ...
  @override
  String toString() {
    return 'RegisterObject(userName: $userName, password: $password, email: $email, mobileNumber: $mobileNumber, countryMobileCode: $countryMobileCode, profilePicture: $profilePicture)';
  }
